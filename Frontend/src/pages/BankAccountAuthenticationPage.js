  ...
  return (
    <CSSTransition in={true} appear={true} timeout={300} classNames="fade">
      <div className='auth-container'>
        <div>
          <button className="cursor-pointer duration-200 hover:scale-125 active:scale-100" title="Go Back" onClick={onClickBackButton}>
        ...
        <div className="account-input-container">
            <div>logo</div>
            <input className="input" type="text" placeholder="신한은행 계좌번호를 입력하세요" onChange={onBankAccountChanged} value={bankAccount} id="bankAccount" disabled={accountChange} />
